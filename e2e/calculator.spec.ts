...
import { clearDatabase, createGroup, createStandardPortfolio, addAsset, expandGroup, navigateTo } from './helpers'
...
test('shows empty state', async ({ page }) => {
  ...
  await expect(page.getByText('Add groups and assets in the Portfolio tab')).toBeVisible()
})
