...
function pctHint(
  ...
  if (diff > 0)
    return t('calculator.pctAboveTarget', { value: diff.toFixed(1) });
                  ...
                  >
                    ...
                    {stats && (
                      ...
                      >
                        <Typography
                          ...
                          sx={{
                            color: pctColor(
                              ...
                              group.deviationThreshold,
                            ),
                          }}
                        >
                          {t('calculator.currentPct', {
                            value: stats.currentPct.toFixed(1),
                          })}
                          {' ('}
                        ...
                        >
                          {t('calculator.afterPct', {
                            value: stats.afterPct.toFixed(1),
                          })}
                          {' ('}
      ...
      {remainder > 0.005 && (
        <Alert severity="info" sx={{ mt: 2 }}>
          <Typography variant="body2">
            {t('calculator.remainder', {
              value: formatCurrency(remainder, locale),
            })}
          </Typography>
        </Alert>
      )}
