...
describe('CalculatorInputForm', () => {
  ...
  it('calls onTotalInvestmentChange when investment field changes', async () => {
    ...
    render(
      <CalculatorInputForm {...defaultProps} onTotalInvestmentChange={onTotalInvestmentChange} />,
    )
  ...
  it('calls onReset when reset button is clicked', async () => {
    const onReset = vi.fn()
    render(<CalculatorInputForm {...defaultProps} hasResult={true} onReset={onReset} />)
