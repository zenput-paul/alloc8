...
describe('useCalculator', () => {
  ...
  it('returns displayAllocations from emptyAllocations when no result', () => {
    ...
    expect(result.current.displayAllocations).toEqual(
      result.current.emptyAllocations,
    );
  ...
  it('returns displayAllocations from result after calculation', () => {
    ...
    expect(result.current.displayAllocations).toEqual(
      result.current.result!.allocations,
    );
    expect(result.current.displayRemainder).toBe(
